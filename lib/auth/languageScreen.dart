                        ...
                        child: Container(
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Container(
                                  margin: EdgeInsets.only(left: 32.0,bottom:32.0,right:16.0),
                                  decoration: BoxDecoration(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      Container(
                                        ...
                                        margin: EdgeInsets.fromLTRB(16.0,16.0,4.0,4.0),
                                        child: Text(
                                          hindi,
                                          style : TextStyle(
                              ...
                              Expanded(
                                child: Container(
                                  margin: EdgeInsets.only(left: 16.0,bottom:32.0,right:32.0),
                                  decoration: BoxDecoration(
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      Container(
                                        alignment: AlignmentDirectional.centerStart,
                                        margin: EdgeInsets.fromLTRB(16.0,12.0,4.0,4.0),
                                        child: Text(
                                          english,
                                          style : TextStyle(
                                            fontFamily: 'Nunito Sans',
